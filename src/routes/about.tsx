...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Our mission, why we built Hajazna, and our commitment to trust and safety for travelers in Syria." },
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-br from-primary/10 via-background to-accent/20 py-20">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
            <p className="text-sm font-medium uppercase tracking-wider text-primary">About Hajazna</p>
            <h1 className="mt-3 font-display text-4xl font-bold sm:text-5xl">Reconnecting travelers with Syria's beauty</h1>
            <p className="mt-5 text-lg text-muted-foreground">
              Hajazna is a modern platform built to showcase the best villas and private stays across Syria — making it simple and safe to discover the country's timeless hospitality.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="mt-4 font-display text-2xl font-semibold">Why We Built Hajazna</h2>
              <p className="mt-3 leading-relaxed text-muted-foreground">
                Syria's tourism market lacked a modern, trustworthy platform for villa rentals. We built Hajazna to fill that gap — combining premium design with local expertise.
              </p>
            </div>
            <div>
              ...
              <p className="mt-3 leading-relaxed text-muted-foreground">
                Every property on Hajazna is personally inspected. We verify hosts, check amenities, and stay in close contact with you throughout your booking and stay.
              </p>
            </div>
            <div>
